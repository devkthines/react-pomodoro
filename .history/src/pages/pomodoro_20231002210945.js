...
export default function ClockFace() {
  ...
  const darkLight = (e) =>{
    ...
    setTheme('dark')
     ...
     :
     setTheme('light');
     themeClass === 'light' ?setThemeClass('dark'): setThemeClass('dark')
  ...
  return (
    <div id='watchBand'>
      ...
      <div id='buttons'>
        ...
        <button className='controls' onClick={darkLight}></button>
        <button className='controls' onClick={onChangePause}>Start/Stop</button><>{theme === 'light'? <GrMoon></GrMoon> : <GiSun></GiSun>}</>
      </div>
      <div id='title'>
        <h1>POMODORO</h1>
      </div>
