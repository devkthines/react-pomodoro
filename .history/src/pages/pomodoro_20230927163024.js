    ...
    <div id='watchBand'>
      ...
      <div id='timersliders'>
        <div className='sliders'>
          <label id='break-label' className={whatIsIt === 'BREAK' ? 'no-bold' : 'bold'} htmlFor="breakSlide">Break:&nsp;{Converter(breakT)}</label>
        ...
        <div className='sliders'>
          ...
          <label id='session-label' className={whatIsIt === 'SESSION' ? 'bold' : 'no-bold'} htmlFor="sessSlide">Session:&nsp;{Converter(session)}</label>
