  ...
  return (
    <div className={themeClass} id='watchBand'>
      ...
      <div id='buttons'>
        ...
        <Button type="primary" shape="circle" icon={<GrPowerReset />}  />
        <Switch
      checkedChildren={<GiPauseButton />}
      unCheckedChildren={<GrCirclePlay />}
      defaultChecked
      onClick={onClick={onChangePause}}
    />
        <Switch
      checkedChildren={<GiSun />}
      unCheckedChildren={<GrMoon />}
      defaultChecked
      onClick={()=>{themeClass === 'light' ?setThemeClass('dark'): setThemeClass('light')
    }}
    />
      </div>
      <div id='title'>
