    ...
    <div id='watchBand'>
      ...
      <div id='timersliders'>
        <div className='sliders'>
          <h6>Break</h6>
          <label id='break-label' className={whatIsIt === 'BREAK' ? 'no-bold' : 'bold'} htmlFor="breakSlide">Length: {Converter(breakT)}</label>
        ...
        <div>
          <h6>Session</h6>
          <label id='session-label' className={whatIsIt === 'SESSION' ? 'bold' : 'no-bold'} htmlFor="sessSlide">Length : {Converter(session)}</label>
