    ...
    <div id='watchBand'>
      ...
      <div id='timersliders'>
        <div className='sliders'>
          <h6>Break</h6>
          <label id='break-label' className={whatIsIt === 'BREAK' ? 'no-bold' : 'bold'} htmlFor="breakSlide">{Converter(breakT)}</label>
        ...
        <div className='sliders'>
          <h6>Session</h6>
          <label id='session-label' className={whatIsIt === 'SESSION' ? 'bold' : 'no-bold'} htmlFor="sessSlide">{Converter(session)}</label>
      ...
      <div id='buttons'>
        <button className='' onClick={onChangePause}>Start/Stop</button>
        <button className=''><GrMoon></GrMoon></button>
        <button className='' onClick={onResetClick}>Reset</button>
      </div>
      <div id='title'>
        <h1>POMODORO</h1>
      </div>
